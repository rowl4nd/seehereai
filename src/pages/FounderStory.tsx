      ...
      <main className="flex-1 px-6 py-16 md:py-24">
        <div className="max-w-2xl mx-auto space-y-10">
          ...
          <div className="space-y-7 text-base leading-relaxed" style={{ color: "#3d3a35" }}>
            ...
            <p style={{ color: "#5f5a53" }}>
              I think it's remarkable, honestly. More than I believed it could be when I started.
            </p>
          ...
          <div className="rounded-2xl p-8 space-y-4" style={{ backgroundColor: "#f1ede8" }}>
            <h2 className="text-lg font-serif font-light" style={{ color: "#3d3a35" }}>
              Ce's background
            </h2>
          ...
          <div className="text-center space-y-5 py-8">
            <p className="text-lg font-serif font-light" style={{ color: "#3d3a35" }}>
              Experience what Ce built.
            </p>
            <p className="text-sm" style={{ color: "#5f5a53" }}>
              Two free sessions. No account needed. No waiting list.
            </p>
            <button
